...
namespace XamlFlair.Extensions
{
	internal static class AnimationSettingsExtensions
	{
		...
		internal static AnimationSettings ApplyOverrides(this AnimationSettings settings, AnimationSettings other)
		{
			...
			updated.OffsetX = !offsetX.Equals(AnimationSettings.DEFAULT_TRANSLATION, System.StringComparison.OrdinalIgnoreCase) ? offsetX : settings.OffsetX;

			var offsetY = other.OffsetY;
			updated.OffsetY = !offsetY.Equals(AnimationSettings.DEFAULT_TRANSLATION, System.StringComparison.OrdinalIgnoreCase) ? offsetY : settings.OffsetY;
